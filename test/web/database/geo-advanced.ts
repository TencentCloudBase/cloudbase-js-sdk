...
export function registerGeoAdvanced(app, collName) {
  ...
  register('database geo: GEO Advanced - CRUD', async () => {
  ...
  register('database geo: GEO - bad create', async () => {
    await new Promise(async resolve => {
      try {
        // bad Point
  ...
  register('database geo: GEO - geoNear', async () => {
    await new Promise(async resolve => {
      try {
        // Create
  ...
  register('database geo: GEO - geoWithin', async () => {
    await new Promise(async resolve => {
      try {
        // Create
        const res = await collection
